      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        <div className="animate-fade-in-up">
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-4xl mx-auto mb-10 leading-relaxed">
            {t("hero.subheadline")} <span className="text-white">iApply™</span>, <span className="text-white">CommunicaringSchool™</span>, <span className="text-white">Rosetta Livingstone™</span>, <span className="text-white">xPortMatch™</span>, <span className="text-white">NewsToast™</span>, <span className="text-white"><a href="https://bizmeetbyc.se/" target="_blank" rel="noopener noreferrer" className="hover:text-accent-light transition-colors">BizMeet™</a></span>, <span className="text-white"><a href="https://carbonx.se/" target="_blank" rel="noopener noreferrer" className="hover:text-accent-light transition-colors">CarbonX™</a></span>.
