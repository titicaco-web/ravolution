    ...
    <section className="py-20 px-6 bg-background">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-14">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-3">{t("timeline.heading")}</h2>
          <p className="text-muted-foreground text-lg">{t("timeline.subheading")}</p>
        </div>
