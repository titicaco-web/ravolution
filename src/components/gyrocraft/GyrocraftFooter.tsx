      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            <Link to="/gyrocraft" className="text-2xl font-display font-bold text-gyrocraft-text mb-4 block">
              GYROCRAFT
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/gyrocraft/licensing" className="text-gyrocraft-text/60 hover:text-gyrocraft-teal transition-colors">
                  Licensing Tiers
                </Link>
              </li>
              <li>
                <Link to="/gyrocraft/licensing#satellite" className="text-gyrocraft-text/60 hover:text-gyrocraft-teal transition-colors">
                  Satellite Operators
                </Link>
              </li>
              <li>
                <Link to="/gyrocraft/licensing#military" className="text-gyrocraft-text/60 hover:text-gyrocraft-teal transition-colors">
                  Defense Contractors
                </Link>
              </li>
              <li>
                <Link to="/gyrocraft/licensing#aam" className="text-gyrocraft-text/60 hover:text-gyrocraft-teal transition-colors">
                  eVTOL Manufacturers
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/gyrocraft/investors" className="text-gyrocraft-text/60 hover:text-gyrocraft-teal transition-colors">
                  Investment Thesis
                </Link>
              </li>
              <li>
                <Link to="/gyrocraft/investors#financials" className="text-gyrocraft-text/60 hover:text-gyrocraft-teal transition-colors">
                  Financial Projections
                </Link>
              </li>
              <li>
                <Link to="/gyrocraft/acquisition" className="text-gyrocraft-text/60 hover:text-gyrocraft-teal transition-colors">
                  Patent Acquisition
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-gyrocraft-text/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-4">
            ...
            <Link to="/" className="text-gyrocraft-text/40 hover:text-gyrocraft-teal text-sm flex items-center gap-1 transition-colors">
              Back to Ravolution <ExternalLink className="w-3 h-3" />
            </Link>
          </div>
          <div className="flex gap-6">
            <Link to="/privacy-policy" className="text-gyrocraft-text/40 hover:text-gyrocraft-teal text-sm transition-colors">
              Privacy Policy
            </Link>
            <Link to="/terms-of-service" className="text-gyrocraft-text/40 hover:text-gyrocraft-teal text-sm transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
