...
import { Briefcase, GraduationCap, Languages, Globe, Dog, Heart, ShieldAlert, ShieldCheck, Droplets, Home, Calendar, Gift, ExternalLink, Newspaper, PartyPopper, Handshake, Leaf, ScanLine, Footprints } from "lucide-react";
