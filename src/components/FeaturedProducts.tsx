          ...
          <div className="bg-card rounded-2xl border-2 border-primary/40 shadow-elevated overflow-hidden transition-all duration-300 hover:shadow-[0_20px_50px_-12px_rgba(0,51,102,0.25)] hover:-translate-y-1 ring-2 ring-primary/20">
            <div className="bg-gradient-to-br from-primary/15 to-primary/5 p-6 relative overflow-hidden">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">Candidate-Centric Transparent Recruitment</p>
              </div>
            </div>
            ...
            <div className="p-6">
              ...
              <ul className="space-y-1.5 mb-5 text-muted-foreground text-sm">
                <li className="flex items-center gap-2">
                  ...
                  Real-time recruiter action transparency
                </li>
                <li className="flex items-center gap-2">
          ...
          <div className="bg-card rounded-2xl border-2 border-accent/40 shadow-elevated overflow-hidden transition-all duration-300 hover:shadow-[0_20px_50px_-12px_rgba(0,102,102,0.25)] hover:-translate-y-1 ring-2 ring-accent/20">
            <div className="bg-gradient-to-br from-accent/15 to-accent/5 p-6 relative overflow-hidden">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">Ambient Language Learning Revolution</p>
              </div>
            </div>
            ...
            <div className="p-6">
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="bg-secondary rounded-lg p-3">
                  ...
                  <div className="text-xs text-muted-foreground">Language learning 2035</div>
                </div>
                <div className="bg-secondary rounded-lg p-3">
                  <div className="flex items-center gap-1.5 text-accent mb-1">
                    <TrendingUp className="w-4 h-4" />
                    <span className="text-xs font-medium">Year 5 Revenue</span>
                  </div>
                  <div className="text-lg font-bold text-foreground">€730M+</div>
                  <div className="text-xs text-muted-foreground">Consolidated projection</div>
                </div>
                <div className="bg-secondary rounded-lg p-3">
                  <div className="flex items-center gap-1.5 text-gold mb-1">
                    <TrendingUp className="w-4 h-4" />
                ...
                <div className="bg-secondary rounded-lg p-3">
                  <div className="flex items-center gap-1.5 text-gold mb-1">
                    ...
                    <span className="text-xs font-medium">Patent Claims</span>
                  </div>
                  <div className="text-lg font-bold text-foreground">23 Claims</div>
                  <div className="text-xs text-muted-foreground">No blocking prior art</div>
                </div>
              </div>

              <h4 className="font-semibold text-foreground text-sm mb-2">Three Market Verticals</h4>
              <ul className="space-y-1.5 mb-5 text-muted-foreground text-sm">
                <li className="flex items-center gap-2">
                  <Users className="w-3.5 h-3.5 text-accent" />
                  Government integration (€2.4-3.8B EU spend)
                </li>
                <li className="flex items-center gap-2">
                  <Radio className="w-3.5 h-3.5 text-accent" />
                  Broadcast media transformation (€85B TAM)
                </li>
                <li className="flex items-center gap-2">
                  <Zap className="w-3.5 h-3.5 text-accent" />
                  Vocational workforce acceleration
                </li>
              </ul>
