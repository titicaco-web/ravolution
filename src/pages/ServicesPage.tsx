...
const buildStructuredData = (lang: string, t: (key: string) => string) => {
  ...
  const faqEntries = lang === "sv" ? [
    ...
    { q: "Hur många patent har Ravolution lämnat in?", a: "27 patent med 369 krav inom 6 branscher inklusive rekrytering, språkutbildning, AI, handel, koldioxidmarknader och modeteknologi." },
    ...
    { q: "¿Cuántas patentes ha registrado Ravolution?", a: "27 patentes con 369 reivindicaciones en 6 industrias incluyendo reclutamiento, educación de idiomas, IA, comercio, mercados de carbono y tecnología de moda." },
    ...
    { q: "How many patents has Ravolution filed?", a: "27 patents with 369 claims across 6 industries including recruitment, language education, AI, trade, carbon markets, and fashion technology." },
  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": "Ravolution AB is a Swedish venture studio that builds custom SaaS platforms, marketplaces, AI tools, recruitment systems, EdTech platforms, and CRMs. MVP delivered in 8–12 weeks. 27 patents filed with 369 claims across 6 industries. Submit a project brief and receive a cost estimate within 48 hours.",
