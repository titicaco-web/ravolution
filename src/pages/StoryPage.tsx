...
const pressJobb: PressItem[] = [
  {
    ...
    body: "Stort reportage (förstasida + uppslag) om Jobbfabriken: verksamheten sysselsatte fler än 500 långtidsarbetslösa och nådde omkring 10 % — två år senare 20 % — ut i arbete, mot omkring 2 % för jämförbara aktörer. Facket var kritiskt — men resultaten lyftes fram.",
    images: [
