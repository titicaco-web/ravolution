  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Reach Ravolution AB. Direct contact with the founding team in Västerås, Stockholm." />
              ...
              <Reveal className="md:col-span-5">
                ...
                <div className="mt-12 space-y-6 border-t border-white/10 pt-8">
                  <div>
                    ...
                    <p className="text-lg text-white/85 font-display mt-2">Västerås — Stockholm, SWE</p>
                  </div>
                  <div>
