...
const companies = [
  ...
  { name: "PikpCash", sector: "Direct Sales · Gamification", status: "CONCEPT · 2017", desc: "Direct sales gamification platform — turns every address into a point of sale and selling into a level-based game. Zero barriers to start earning.", href: "/en/pikpcash" },
  { name: "Pratis", sector: "AI Companion · HealthTech", status: "SEEKING INVESTORS", desc: "A calm, Swedish-speaking AI companion for lonely older adults — a voice that remembers you and is simply there to talk. Companionship, not care. Co-owned with Susanne Örtegren.", href: "/en/pratis" },
  { name: "SINGUISTIC", sector: "EdTech · Language Learning", status: "ACTIVE", desc: "Music-native language learning platform — synced dual-language lyrics, tap-to-save vocabulary, spaced repetition and CEFR-anchored reporting. Built on the Spotify Web API, live in 26 languages.", href: "https://singuistic.com" },
